...
import operate1SubtitleLeft from '../../image/activity/operate1-subtitle-left.png'
import operate1SubtitleRight from '../../image/activity/operate1-subtitle-right.png'
import close from '../../image/activity/close.png'
import checkIcon from '../../image/activity/operate1-check-icon.png'

const ArticleReadACT = () => {
    ...
    return (
        <div className={`articleReadACTContainer `}>
            {data ? (
                <>
                    <div className="part1">
                        <Image
                    ...
                    <div className="part2">
                        <div className="part2Subtitle">
                            <Image src={operate1SubtitleLeft} fit="contain" className="part2SubtitleImg"></Image>
                            <div className="part2SubtitleText">
                                ...
                                <span style={{letterSpacing: '0px', fontWeight: 'bold'}}>{data.sub_title?.[2]}</span>
                                <span style={{marginLeft: '5px'}}>{data.sub_title?.[3]}</span>
                            </div>
                            <Image src={operate1SubtitleRight} fit="contain" className="part2SubtitleImg"></Image>
                        </div>
                        <Image
                            src={data?.head_img?.[0]}
                            fit="contain"
            ...
            <SafeArea position="bottom" style={{background: '#F34E26'}} />
        </div>
    )
}

export default ArticleReadACT
