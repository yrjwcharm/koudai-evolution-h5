...
try {
    deviceWidth = window.innerWidth > 0 ? window.innerWidth : window.screen.width //设备的宽度
    deviceHeight = window.innerHeight > 0 ? window.innerWidth : window.screen.height //设备的高度
} finally {
    if (!deviceWidth) deviceWidth = 375
    if (!deviceHeight) deviceHeight = 812
}
